declare interface util {
  ...
  compareElements(
    a: Node,
    b: Node
  ): { ancestor: Element | null; a: Node; b: Node; result: number };
   ...
   * @param toolbarItem Button array
   */
  setDisabledButtons(
    disabled: boolean,
    toolbarItem: Element[] | HTMLCollection | NodeList
  ): void;
