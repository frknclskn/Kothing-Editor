    ...
    const wrongTags = this.getListChildNodes(
      ...
      function (current) {
        ...
        if (
          ...
          this.isNotCheckingNode(current)
        ) {
        ...
        if (this.isCell(current)) {
          ...
          if (
            !this.isFormatElement(fel) &&
            !this.isRangeFormatElement(fel) &&
            !this.isComponent(fel)
          ) {
