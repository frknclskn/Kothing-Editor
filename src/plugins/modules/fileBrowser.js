...
(function (global, factory) {
  ...
  const fileBrowser = {
    ...
    _drawFileList: function (url, browserHeader) {
      ...
      const xmlHttp = (fileBrowserPlugin._xmlHttp =
        this.util.getXMLHttpRequest());
      xmlHttp.onreadystatechange = fileBrowserPlugin._callBackGet.bind(
        this,
        xmlHttp
      );
