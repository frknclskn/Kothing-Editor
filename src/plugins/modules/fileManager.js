    ...
    setInfo: function (
      ...
      if (resizing) {
        ...
        if (!element.getAttribute("data-origin")) {
          ...
          const h = this.plugins.resizing._module_getSizeY.call(
            this,
            context,
            element,
            cover,
