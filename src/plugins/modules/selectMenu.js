...
export default {
  ...
  initEvent: function (pluginName, forms) {
    const form = forms.querySelector(".ke-select-list");
  ...
  moveItem: function (listContext, num) {
    ...
    const selectIndex = (listContext.index =
